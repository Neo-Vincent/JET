 ...
 */
define(['ojs/ojcore', 'knockout', 'data/data', 'moment', 'ojs/ojknockout', 'ojs/ojvalidation', 'ojs/ojtagcloud', 'ojs/ojchart', 'ojs/ojnavigationlist', 'ojs/ojdatacollection-common'],
        function (oj, ko, jsonData, moment)
        {
            ...
            function PersonViewModel() {
                ...
                function getEmpURL(id) {
                    var url;
                    if (id) {
                        url = "../static/js/data/employee" + id + ".json";
                    } else {
                        url = "../static/js/data/employee100.json";
                    }
                    return url;
                }
                ...
                self.getPhoto = function (id) {
                    ...
                    var src;
                    if (id < 188) {
                        src = '../static/css/images/people/' + id + '.png';
                    } else {
                        src = '../static/css/images/people/nopic.png';
                    }
                    return src;
                };
